				...
				<div class="col-md-12">
                    ...
                    <div class="row">
						...
						<div class="col-md-offset-0 col-md-2">
							...
							-->
							<input type="date" class="form-control" name="date" id="date" placeholder="select another date">
						</div>
<!--
					...
					<div class="portlet box blue">
                        ...
                        @foreach ($employees as $employee)
                            <tr id="row{{ $employee->employeeID }}">
                                ...
                                <td class="">
                                    <a class="btn purple btn-circle" href="{{route('admin.attendances.show',$employee->employeeID) }}">
