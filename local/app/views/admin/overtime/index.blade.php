...
@section('mainarea')
			...
			<div class="row">
				<div class="col-md-6">
				 ...
				 <a class="btn green" data-toggle="modal" href="{{URL::to('admin/overtime/create')}}">
                                        Add New Overtime
...
<!-- END PAGE LEVEL PLUGINS -->
	...
	<script>
        	...
        	$('#overtime').dataTable( {
                        "bProcessing": true,
                        //"bServerSide": true,
                        "sAjaxSource": "{{ route("admin.ajax_overtime") }}",
                        "aaSorting": [[ 1, "asc" ]],
                        "aoColumns": [
		...
		function del(id,Name)
		{
			...
			$('#info').html('Are you sure you want to delete overtime for <strong>'+Name+'</strong>??');
			$("#delete").click(function()
			{
					var url = "{{ route('admin.overtime.destroy',':id') }}";
