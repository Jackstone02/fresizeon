...
@section('mainarea')
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('admin.expenses.index') }}">Office Expenses</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="expenses">
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="hidden" class="form-control" name="department[]" value="0">
    ...
    var div = '';
        div += '<div class="form-group">';
            div += '<div class="col-md-2">';
                div += '<input type="hidden" class="form-control" name="department[]" value="0">';
