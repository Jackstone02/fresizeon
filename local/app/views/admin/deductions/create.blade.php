                ...
                {{--END ERROR MESSAGE BOX--}}
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-trophy"></i>Give deduction
							</div>
							<div class="tools">
							</div>
						</div>
						...
						<!-- BEGIN FORM-->
						{{Form::open(array('url'=>"admin/deductions",'class'=>'form-horizontal form-bordered','method'=>'POST'))}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="number" class="form-control" name="amount" placeholder="Amount" value="{{ Input::old('amount') }}">
                                </div>
                            </div>
