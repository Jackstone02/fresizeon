                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                             <div class="col-md-6">
                                                ...
                                                <input class="form-control form-control-inline input-medium date-picker" name="date[0]" type="date" value="" placeholder="Date"/>
...
<!-- / DATEPICKER -->
    <script>
            ...
            $('#plusButton').click(function(){
              $i = $i+1;
              $(' <div class="form-group"> ' +
               '<div class="col-md-6"><input class="form-control form-control-inline input-medium date-picker'+$i+'" name="date['+$i+']" type="date" value="" placeholder="Date"/></div>' +
