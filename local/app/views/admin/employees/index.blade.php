			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="load">
                   	...
                   	<a href="{{route('admin.employees.create')}}" class="btn green btn-circle">
						...
						<div class="portlet-body">
							...
							@foreach ($employees as $employee)
                                <tr id="row{{ $employee->employeeID }}">
                                    ...
                                    <td class="text-center">
                                    <p> <a class="btn purple btn-circle btn-circle" href="{{ route('admin.employees.edit',$employee->employeeID)  }}"><i class="fa fa-edit"></i> View/Edit</a></p>
                                    <p> <a class="btn red btn-circle" style="width: 105px;" href="javascript:;" onclick="del('{{$employee->employeeID}}','{{ $employee->fullName }}')"><i class="fa fa-trash"></i> Delete</a></p>
                                    </td>
                                </tr>
							@endforeach
