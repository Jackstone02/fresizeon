	...
	<div class="page-sidebar-wrapper">
        ...
        <li class="{{ $departmentOpen or ''}}">
          ...
          {{---------------------------------------/Department-------------------------------}}
              ...
              {{---------------------------------------Awards and Deductions-------------------------------}}
                    <li class="{{ $awardsOpen or ''}}">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="{{ $deductionsActive or ''}}">
                                        <a href="{{route('admin.deductions.index')}}">
                                        <i class="fa  fa-frown-o"></i>
                                        {{Lang::get('menu.deductionsList')}}</a>
                                    </li>
                                </ul>
                    </li>
            ...
            {{---------------------------------------Payslip and Overtime-------------------------------}}
                    <li class="{{ $payslipOpen or ''}}">
                                <a href="javascript:;">
                                <i class="fa fa-money"></i>
                                <span class="title">{{Lang::get('menu.payslip')}}</span>
                                <span class="arrow "></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="{{ $payslipActive or ''}}">
                                        <a href="{{route('admin.payslip.index')}}">
                                        <i class="fa  fa-money"></i>
                                        {{Lang::get('menu.payslipList')}}</a>
                                    </li>
                                </ul>
                            </li>
            {{---------------------------------------/Payslip-------------------------------}}
              ...
              {{---------------------------------------Expense-------------------------------}}
                    <li class="{{ $expensesOpen or ''}}">
                                ...
                                <ul class="sub-menu">
                                    <li class="{{ $projectexpensesActive or ''}}">
                                        <a href="{{route('admin.projectexpenses.index')}}">
                                        <i class="fa  fa-book"></i>
                                        {{Lang::get('menu.projectexpensesList')}}</a>
                                    </li>
                                    <li class="{{ $expensesActive or ''}}">
                                        <a href="{{route('admin.expenses.index')}}">
                                        <i class="fa  fa-desktop"></i>
                                        {{Lang::get('menu.officeexpenseList')}}</a>
                                    </li>
              ...
              {{---------------------------------------/Expense-------------------------------}}
                ...
                {{---------------------------------------Reports-------------------------------}}
                    ...
                    <li class="{{ $reportsOpen or ''}}">
                                ...
                                <ul class="sub-menu">
                                    <li class="{{ $reportsActive or ''}}">
                                        <a href="{{route('admin.reports.index')}}">
                                        <i class="fa  fa-book"></i>
                                        {{Lang::get('menu.reportsList')}}</a>
                                    </li>
                                    <li class="{{ $overallActive or ''}}">
                                        <a href="{{route('admin.reports.overall')}}">
                                        <i class="fa  fa-signal"></i>
                                        {{Lang::get('menu.overallList')}}</a>
                                    </li>
