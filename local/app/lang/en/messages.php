<?php
 ...
 return [
	...
	*/
	 ...
	 'deleteNoteDesignation'   => '<strong>Note:</strong> Deleting a project will delete all the <strong>Employees</strong> associated with it',
	 //'noDept'   => '<strong>Note:</strong> There no <strong>Department</strong> in the database.Please create the Department First'
	 'noDept'   => '<strong>Note:</strong> No <strong>Project</strong> in the database. Please create the Project first'
