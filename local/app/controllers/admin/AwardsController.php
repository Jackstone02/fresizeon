...
class AwardsController extends \AdminBaseController {
    ...
    public function __construct()
    {
        ...
        $this->data['pageTitle']  =  'Awards/Bonuses';
    }
    ...
    public function ajax_awards()
    {
	    ...
	    $result =
		    Award::select('awards.id','awards.employeeID','fullName','awardName','gift','cashPrice','date')
        ...
        return Datatables::of($result)
            ...
            ->add_column('edit', '
                        <a  class="btn purple btn-circle"  href="{{ route(\'admin.awards.edit\',$id)}}" ><i class="fa fa-edit"></i> View/Edit</a>
                            &nbsp;<a href="javascript:;" onclick="del(\'{{ $id }}\',\'{{ $fullName}}\',\'{{ $awardName }}\');return false;" class="btn red btn-circle">
	...
	public function store()
	{
		...
		return Redirect::route('admin.awards.index')->with('success',"<strong>{$employee->fullName}</strong> is awarded");
	}
